...
class ToolMatcher:
    ...
    def _cosine_similarity(self, a, b):
        ...
        try:
            ...
            if torch.is_tensor(a) and torch.is_tensor(b):
                ...
                return np.atleast_1d(similarity.squeeze().cpu().numpy())
        except ImportError:
            pass
        ...
        try:
            ...
            return np.atleast_1d(similarity.squeeze())
        except Exception as e:
    ...
    def _cosine_similarity_tfidf(self, task_vector, tool_matrix):
        ...
        try:
            ...
            return np.atleast_1d(similarities.squeeze())
        except ImportError:
    ...
    def get_semantic_similarity(self, text1: str, text2: str) -> float:
        ...
        try:
            ...
            return float(similarity[0]) if isinstance(similarity, np.ndarray) and similarity.ndim > 0 else float(similarity)
        except Exception as e:
